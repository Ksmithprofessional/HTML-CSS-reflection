...
?>
    ...
    <div class="image-slideshow single-item">
        <div class="slide-1">
            <!-- <img src="Images/slide-1.jpg" alt="Computer with sysflow on screen"> -->
            <div class="image-content-centering">
                <div class="image-content">
                    <h1>Bespoke Software</h1>
                    <p>Bring your business together <br>
                    with solutions that grow with you.</p>
                    <div class="center-button">
                        <div class="image-btn"><a href="#">Find out more <i class="fas fa-arrow-right"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="slide-2">
            <!-- <img src="Images/slide-2.jpg" alt="People looking at a computer screen"> -->
            <div class="image-content-centering">
                <div class="image-content">
                    <h1>It Support</h1>
        ...
        <div class="slide-3">
            <!-- <img src="Images/slide-3.jpg" alt="People analysing a graph"> -->
            <div class="image-content-centering">
                <div class="image-content">
                    ...
                    <div class="center-button">
                        <div class="image-btn"><a href="#">See how we can help you <i class="fas fa-arrow-right"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="slide-4">
            <!-- <img src="Images/slide-4.jpg" alt="A touchpad with numbers"> -->
            <div class="image-content-centering">
                <div class="image-content">
        ...
        <div class="slide-5">
            <!-- <img src="Images/slide-5.jpg" alt="A person working on a graphics tablet"> -->
            <div class="image-content-centering">
                <div class="image-content">
                    <h1>Web Design</h1>
        ...
        <div class="slide-6">
            <!-- <img src="Images/slide-6.jpg" alt="A padlock"> -->
            <div class="image-content-centering">
                <div class="image-content">
    ...
    <main>
        ...
        <div class="background-fix-2"> <!-- i do not like these background fixes -->
            <div class="bio">
                ...
                <div class="culture-but"><a href="#">Our culture <i class="fas fa-arrow-right"></i></a></div> <!-- Needs an after arrow-->
            </div>
        </div>
